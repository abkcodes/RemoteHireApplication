...
<header className="container-nav">
      ...
      <div className="nav">
        ...
        <div className="nav-profile">
          ...
          <AccountBox   sx={{ fontSize: 35 }} /><div>{localStorage.getItem("hr")}</div>
      ...
      <div  className="container-below-nav  shed">
        <Toolbar  className="options-below-nav"  style={toolbar1}   sx={{width:"100%",maxWidth:"600",mx:"auto"}}>
          ...
          <grid container rowSpacing={1} columnSpacing={{xs:2,sm:2,md:3}} >
            ...
            <grid item xs={4} md={4} style={grid1}  >
              <Link to="/hr/hrapplication" style={{color:"white",textDecoration:"none"}}  >
                <IconButton className="options-below-nav-items options-student" edge="start"   ariel-label="menu" sx={{mr:2}}>Application
                </IconButton>
                 </Link>
            </grid>
